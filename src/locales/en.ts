const locale: Record<string, string> = {
  ...
  'app.setting.multiTab': 'Tab',
  'app.setting.multiTab.uni': 'Unitab',
  'app.setting.multiTab.multi': 'Multitab',
  'app.setting.multiTab.allClose': 'Close All',
  'app.setting.multiTab.closeCurrent': 'Close Current',
  'app.setting.multiTab.snackbar.closeend': "This is last tab, can't be shut down",
  'app.setting.multiTab.snackbar.close': 'Close',
